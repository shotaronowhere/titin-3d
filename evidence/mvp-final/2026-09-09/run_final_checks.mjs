...
const checks = [
  ...
  ['chromium', 'npx', ['playwright', 'test', ...['final-polish','mvp-preview','stretch','learn','evidence','workbench','smoke','ux-overhaul'].map(n=>`test/browser/${n}.spec.js`), '--project=chromium', '--grep-invert', '@sweep']],
  ...
  ...['firefox'].map(engine=>[engine, 'npx', ['playwright','test', ...['final-polish','mvp-preview','stretch','learn','evidence'].map(n=>`test/browser/${n}.spec.js`), `--project=${engine}`]]),
];
const results = [];
