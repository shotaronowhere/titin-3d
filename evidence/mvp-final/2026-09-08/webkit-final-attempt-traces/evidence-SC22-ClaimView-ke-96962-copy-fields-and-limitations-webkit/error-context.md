...
- Name: evidence.spec.js >> SC22 ClaimView keeps citations after copy, fields, and limitations
- Location: test/browser/evidence.spec.js:125:1

# Error details

```
Error: page.setViewportSize: Test ended.
```
