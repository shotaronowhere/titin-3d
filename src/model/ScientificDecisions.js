/** Pure SC-19 decision-ledger normalization for runtime and presentation use. */
...
export function decisionLedger(spec) {
  ...
  if (record?.schema !== 'titin-scientific-decisions/1') {
    throw new Error('scientific_decisions.json must use titin-scientific-decisions/1');
  }
