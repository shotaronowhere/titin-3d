...
export { STAGE_LAYOUT, BRACKET_LANE_OFFSETS, bracketLaneY, inspectorPlacement, axisPxPerNm, scaleBar } from './src/presentation/StageLayout.js';
`);
...
let page = pageModule
  .replace(IMPORT_RE, () => {
    if (!first) return '';
    first = false;
    return 'const { TitinModel, TitinVisualization, SCALES, Viewer, VIEWS, CLOSEUPS, COMPONENT_COLOR, EVIDENCE_STYLE, COMPONENTS, EVIDENCE_CLASSES, StoryController, AUDIENCE_MODES, isLongitudinalProjection, STAGE_LAYOUT, BRACKET_LANE_OFFSETS, bracketLaneY, inspectorPlacement, axisPxPerNm, scaleBar } = __titinBundle;\n';
  })
...
const standalone = html
  ...
  .replace(
    ...
    lit([
      ...
      'return { TitinModel, TitinVisualization, SCALES, Viewer, VIEWS, CLOSEUPS, COMPONENT_COLOR, EVIDENCE_STYLE, COMPONENTS, EVIDENCE_CLASSES, StoryController, AUDIENCE_MODES, isLongitudinalProjection, STAGE_LAYOUT, BRACKET_LANE_OFFSETS, bracketLaneY, inspectorPlacement, axisPxPerNm, scaleBar };',
      '})();',
      '',
